  ...
  <div class="landing-page">
      ...
      <section class="container mx-auto pt-24">
        ...
        <div class="grid grid-cols-3 gap-4 mt-3">
          <div
            v-for="campaign in campaigns.data" :key="campaign.id" class="card-project w-full p-5 border border-gray-500 rounded-20"
          >
            <div class="item">
      ...
      <section class="container mx-auto pt-24">
        ...
        <div class="flex mb-10">
          ...
          <div class="w-8/12 mt-16">
            <h2 class="text-3xl text-gray-900 h-12">
...
export default {
  async asyncData({ $axios }) {
    const campaigns = await $axios.$get('/campaigns')
